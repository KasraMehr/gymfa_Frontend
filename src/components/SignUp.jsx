    ...
    <div className="grid grid-cols-2 p-5" dir='rtl'>
      <div className="text-white">
        ...
        <div className="mt-12 items-center">
            ...
            <div className="text-xl flex justify-center mt-6">برای استفاده از تمامی امکانات پلتفرم حساب کاربری بسازید.</div>
        </div>
        ...
        <div className="mt-5 flex text-center justify-center text-xl">
          ...
          <div className="bg-bg border rounded-2xl w-44 h-8 ml-2">
            مربی
          </div>
          <div className="bg-bg border rounded-2xl w-44 h-8 ml-2">
            مالک
